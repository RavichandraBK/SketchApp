...
export default function SketchEditor() {
  ...
  function handleEraserAction(e,shapeId) {
    
    if (action === ACTIONS.ERASER) {
      setRectangles((prevRectangles) =>
        prevRectangles.filter((rectangle) => rectangle.id !== shapeId)
      );
      setCircles((prevCircles) =>
        prevCircles.filter((circle) => circle.id !== shapeId)
      );
      setArrows((prevArrows) =>
        prevArrows.filter((arrow) => arrow.id !== shapeId)
      );
      setScribbles((prevScribbles) =>
        prevScribbles.filter((scribble) => scribble.id !== shapeId)
      );
    }
  }
          ...
          <Layer>
            ...
            {rectangles.map((rectangle) => (
              <Rect
                ...
                onClick={onClick}
                onPointerDown={(e)=>{handleEraserAction(e,rectangle.id)}}
                className="shape"
              />
            ))}
            ...
            {circles.map((circle) => (
              <Circle
                ...
                draggable={isDraggable}
                onClick={onClick}
                onPointerDown={(e)=>{handleEraserAction(e,circle.id)}}
                className="shape"
              />
            ))}
            {arrows.map((arrow) => (
              <Arrow
                ...
                draggable={isDraggable}
                onClick={onClick}
                onPointerDown={(e)=>{handleEraserAction(e,arrow.id)}}
                className="shape"
              />
            ))}
            ...
            {scribbles.map((scribble) => (
              <Line
                ...
                draggable={isDraggable}
                onClick={onClick}
                onPointerDown={(e)=>{handleEraserAction(e,scribble.id)}}
                className="shape"
              />
            ))}
